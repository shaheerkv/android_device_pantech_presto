...
const char QCameraParameters::KEY_SKY_COLOREXT_COORDINATES_R[] = "pantech-color-extraction-coordinates-r";
const char QCameraParameters::KEY_SKY_COLOREXT_COORDINATES_G[] = "pantech-color-extraction-coordinates-g";
const char QCameraParameters::KEY_SKY_COLOREXT_COORDINATES_B[] = "pantech-color-extraction-coordinates-b";
const char QCameraParameters::KEY_SKY_COLOREXTRACTION[] = "pantech-colorextraction";
const char QCameraParameters::KEY_SKY_IPL_MODE[] = "pantech-ipl-mode";
const char QCameraParameters::SKY_IPL_OFF[] = "off";
const char QCameraParameters::SKY_COLOREXT_OFF[] = "off";
const char QCameraParameters::KEY_SUPPORTED_SKY_COLOREXTRACTION[] = "T";
const char QCameraParameters::KEY_SKY_COLOREXT_COORDINATES[] = "T";
const char QCameraParameters::KEY_SKY_COLOREXT_RGB_R[] = "pantech-colorextraction-rgb-r";
const char QCameraParameters::KEY_SKY_COLOREXT_RGB_G[] = "pantech-colorextraction-rgb-g";
const char QCameraParameters::KEY_SKY_COLOREXT_RGB_B[] = "pantech-colorextraction-rgb-b";
const char QCameraParameters::SKY_COLOREXT_TOUCH[] = "colorext-touch";
const char QCameraParameters::SKY_COLOREXT_RED[] = "colorext-red";
const char QCameraParameters::SKY_COLOREXT_GREEN[] = "colorext-green";
const char QCameraParameters::SKY_COLOREXT_BLUE[] = "colorext-blue";
const char QCameraParameters::SKY_COLOREXT_YELLOW[] = "colorext-yellow";
const char QCameraParameters::SKY_IPL_CAMNOTE[] = "pantech-ipl-camnote";
const char QCameraParameters::SKY_IPL_BEAUTY[] = "pantech-ipl-beauty";
const char QCameraParameters::SKY_IPL_MINIATURE[] = "pantech-ipl-miniature";
const char QCameraParameters::SKY_IPL_CARTOON[] = "pantech-ipl-cartoon";
const char QCameraParameters::SKY_IPL_CARTOON_FRONT[] = "cartoon-front";
const char QCameraParameters::KEY_SHUTTER_SOUND[] = "shutter-sound";
const char QCameraParameters::KEY_CAMNOTE[] = "camnote";
const char QCameraParameters::KEY_CAMNOTE_MODE[] = "camnote-mode";
const char QCameraParameters::KEY_VT[] = "pantech-vt";
const char QCameraParameters::KEY_MULTISHOT[] = "pantech-multishot";
const char QCameraParameters::MULTISHOT_OFF[] = "off";
const char QCameraParameters::MULTISHOT_ON[] = "on";
const char QCameraParameters::VT_OFF[] = "off";
const char QCameraParameters::REFLECT_OFF[] = "off";
const char QCameraParameters::CAMNOTE_WB_C[] = "wb-c";
const char QCameraParameters::CAMNOTE_OFF[] = "off";
const char QCameraParameters::CAMNOTE_ON[] = "on";
const char QCameraParameters::CAMNOTE_WB_B[] = "wb-b";
const char QCameraParameters::CAMNOTE_BL_B[] = "bl-b";
const char QCameraParameters::CAMNOTE_NORMAL[] = "normal";
const char QCameraParameters::EFFECT_WHITEBOARD_C[] = "whiteboard-c";
const char QCameraParameters::EFFECT_BLACKBOARD_C[] = "blackboard-c";
const char QCameraParameters::KEY_SKY_IPL_VALUE_2[] = "value-2";
const char QCameraParameters::KEY_SKY_IPL_VALUE_1[] = "value-1";
const char QCameraParameters::KEY_REFLECT[] = "pantech-reflect";
const char QCameraParameters::KEY_FOCUS_STEP[] = "pantech-focus-step";
const char QCameraParameters::KEY_FOCUS_COORDINATES[] = "pantech-focus-coordinates";
const char QCameraParameters::KEY_SUPPORTED_SHUTTER_SOUND[] = "pantech-supported-shutter-sound";
const char QCameraParameters::KEY_SUPPORTED_MULTISHOT[] = "pantech-supported-multishot";
const char QCameraParameters::KEY_SUPPORTED_REFLECT[] = "pantech-supported-reflect";
const char QCameraParameters::SCENE_MODE_INDOOR[] = "indoor";
const char QCameraParameters::SCENE_MODE_TEXT[] = "text";
const char QCameraParameters::FLASH_MODE_TORCH_FLASH[] = "tourch-flash";
const char QCameraParameters::SHUTTER_SOUND_OFF[] = "off";
const char QCameraParameters::SHUTTER_SOUND_ON[] = "on";
const char QCameraParameters::H324MVT_ON[] = "on";
const char QCameraParameters::HDVT_ON[] = "off";
const char QCameraParameters::AUTO_EXPOSURE_OFF[] = "off";
const char QCameraParameters::WHITE_BALANCE_OFF[] = "off";
const char QCameraParameters::REFLECT_MIRROR[] = "mirror";
const char QCameraParameters::REFLECT_WATER[] = "water";
const char QCameraParameters::REFLECT_MIRROR_WATER[] = "mirror-water";
#endif
...
#ifdef PANTECH_PRESTO_CAMERA
void QCameraParameters::getColorExtractionCoordinates(int *x, int *y) const {
}
void QCameraParameters::setColorExtractionCoordinates(int x, int y) {
}
void QCameraParameters::getColorExtractionRGB_B(int *x, int *y) const {
}
void QCameraParameters::setColorExtractionRGB_B(int x, int y) {
}
void QCameraParameters::getColorExtractionRGB_G(int *x, int *y) const {
}
void QCameraParameters::setColorExtractionRGB_G(int x, int y) {
}
void QCameraParameters::getColorExtractionRGB_R(int *x, int *y) const {
}
void QCameraParameters::setColorExtractionRGB_R(int x, int y) {
}
void QCameraParameters::getFocusCoordinates(int *x, int *y) const {
}
void QCameraParameters::setFocusCoordinates(int x, int y) {
}
#endif
